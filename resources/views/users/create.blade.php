                            ...
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" data-lpignore="true" name="firstname" class="form-control" value="{{ old('firstname') }}" required />
                                    </div>
                                </div>
                                <div class="col-md-6 pl-1">
                                    <div class="form-group">
                                        <label for="lastname">Lastname</label>
                                        <input type="text" autocomplete="off" data-lpignore="true" name="lastname" class="form-control" value="{{ old('lastname') }}" required />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="email" autocomplete="off" data-lpignore="true" name="email" class="form-control" value="{{ old('email') }}" required />
                                    </div>
                                </div>
                                <div class="col-md-6 pl-1">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 pl-1">
                                                <input type="phone" autocomplete="off" data-lpignore="true" name="mobile" class="form-control pl-1" placeholder="0177 123 456" value="{{ old('mobile') }}" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
